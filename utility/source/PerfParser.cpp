...
LbrSample::LbrSample (const std::string &sample, const LbrTraceType &type) : type_ (type)
{
    ...
    while (!traceReader.isAtEOF ()) {
        ...
        switch (traceType) {
            ...
            case LbrTraceType::TLB_MISS:
                ...
                break;
            case LbrTraceType::Unknown: throw std::runtime_error ("Uknown perf file format");
